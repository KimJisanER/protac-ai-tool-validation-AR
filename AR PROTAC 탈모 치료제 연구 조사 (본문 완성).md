...
**[표1c] AI 검증 분할의 화합물·AR·활성값 분포** (활성 = `DC50<100 nM AND Dmax≥80%`)

| 구분 | 화합물(unique) | AR(P10275) | 양성(활성) | 음성 | AR 양성 | AR 음성 |
|---|---|---|---|---|---|---|
| **검증 hold-out** (STAN 미관측, AI 평가용) | 1,134 | 42 | 388 | 746 | 22 | 20 |
| **학습-관측 대조군** (leaked) | 281 | 63 | 149 | 132 | 31 | 32 |
| 나머지 (PROTAC-DB 3.0 − hold-out) | 9,249 | 616 | — | — | — | — |
| (참고) PROTAC-DB 3.0 전체 | 10,383 | 658 | — | — | — | — |

활성값(DC50·Dmax)은 라벨·ESM커버를 만족하는 검증 분할 유니버스(hold-out 1,134 + 학습-관측 281 = **1,415개**)에만 존재하며, "나머지" 9,249개의 대부분은 분해 라벨이 없다(②-1의 라벨 희소성과 직결).
