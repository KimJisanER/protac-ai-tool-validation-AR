...
| **투과성** | (소분자/펩타이드 검증) | **PROTAC-TS held-out Spearman≈0.8·R²≈0.5**(분해보다 잘 일반화); Potts-Guy 44.8% AD 밖 | **상대적으로 최선이나 불충분** — R²≈0.5·Caco-2≠피부·학습데이터 포화(외부검증 불가) |
